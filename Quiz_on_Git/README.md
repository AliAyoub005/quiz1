...
everything will be pushed except the hidden files 
...
1. it will be in headless state and go at C4 commint
2. c4 will be with the master branch and head on c5 and the master branch
3.the head will be on c5 and we will be on the master branch.
4. master already merged ad will lead to c5 so nothing will happen.
...
yes because all are updated only code.py created .
